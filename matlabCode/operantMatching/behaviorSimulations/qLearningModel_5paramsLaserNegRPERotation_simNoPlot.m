function [t, allRewards, allChoices, blockProbs, blockSwitch, laser] = qLearningModel_5paramsLaserNegRPERotation_simNoPlot(params, maxTrial, randomSeed, varargin)
%
