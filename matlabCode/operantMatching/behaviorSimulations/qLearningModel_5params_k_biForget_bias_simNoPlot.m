function [t, allRewards, allChoices, blockProbs, blockSwitch] = qLearningModel_5params_k_biForget_bias_simNoPlot(params, maxTrial, randomSeed, varargin)
%
%
...
for currT = 1:maxTrial
    ...
    if binornd(1, pRight) == 0 % left choice selected probabilistically
        ...
        Q(currT + 1, 1) = Q(currT, 1)*alphaForget + alpha*rpe;
        ...
        Q(currT + 1, 2) = Q(currT, 2)*alphaForget + alpha*rpe;
