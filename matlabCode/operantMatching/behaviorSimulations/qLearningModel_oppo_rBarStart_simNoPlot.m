function [rBar, allRewards, allChoices, blockProbs, blockSwitch] = qLearningModel_oppo_rBarStart_simNoPlot(varargin)
%
%
...
rBar = [rBarStart; NaN(a.Results.maxTrials-1, 1)];
