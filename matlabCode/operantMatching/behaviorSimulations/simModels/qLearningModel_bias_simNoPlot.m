function [t, allRewards, allChoices, blockProbs, blockSwitch] = qLearningModel_bias_simNoPlot(varargin)
%
%
...
beta = a.Results.params(2);
if length(a.Results.params) == 3
    bias = a.Results.params(3);
else
    bias = 0;
end
