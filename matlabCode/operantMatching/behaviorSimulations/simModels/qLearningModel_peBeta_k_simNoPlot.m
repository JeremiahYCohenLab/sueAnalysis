function [peBar, allRewards, allChoices, blockProbs, blockSwitch] = qLearningModel_peBeta_k_simNoPlot(varargin)
%
%
...
for currT = 1:p.MaxTrials - 1
    ...
    % Select action
    pRight = logistic(beta(currT)*(diff(Q(currT, :))) + k*prevChoice);
