function [rBar, allRewards, allChoices, blockProbs, blockSwitch] = qLearningModel_rAN_simNoPlot(varargin)
%
%
...
if a.Results.tForgetFlag == true;
    tForget = a.Results.params(4);
else
    alphaForget = a.Results.params(4);
end
...
aN =[aNmin; NaN(a.Results.maxTrials-1, 1)];
...
for currT = 1:p.MaxTrials - 1
    ...
    if binornd(1, pLeft) == 0 % left choice selected probabilistically
        ...
        if rpe >= 0
            ...
            Q(currT + 1, 1) = Q(currT, 1) + aN(currT)*rpe;
        end
