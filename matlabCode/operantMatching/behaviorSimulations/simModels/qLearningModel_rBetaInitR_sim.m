function [rBar, allRewards, allChoices, blockProbs, blockSwitch] = qLearningModel_rBetaInitR_sim(varargin)
%
%
...
rBar = [initR; NaN(a.Results.maxTrials-1, 1)];
