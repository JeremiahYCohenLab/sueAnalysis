function [rBar, allRewards, allChoices, blockProbs, blockSwitch] = qLearningModel_rTrace_k_simNoPlot(varargin)
%
%
...
alpha = a.Results.params(1);
aF = a.Results.params(2);
beta = a.Results.params(3);
v = a.Results.params(4);
w = a.Results.params(5);
k = a.Results.params(6);
...
for currT = 1:p.MaxTrials
    ...
    if binornd(1, pRight) == 0 % left choice selected probabilistically
        ...
        rpe = p.AllRewards(currT, 2) - Q(currT, 2) + w * rBar(currT);
