...
for i = 1:length(animals)
    plot([1 2], [probSwitchPre_s(i) probSwitchPost_s(i)], '-', 'linewidth', 2, 'Color', colors(i,:))
end
xticks([1 2]); xticklabels({[pre], [post]})
xlim([0.75 2.25])
...
for i = 1:length(animals)
    plot([1 2], [probSwitchPre_l(i) probSwitchPost_l(i)], '-', 'linewidth', 2, 'Color', colors(i,:))
end
xticks([1 2]); xticklabels({[pre], [post]})
xlim([0.75 2.25])
...
for i = 1:length(animals)
    plot([1 2], [probStayPre_s(i) probStayPost_s(i)], '-', 'linewidth', 2, 'Color', colors(i,:))
end
xticks([1 2]); xticklabels({[pre], [post]})
xlim([0.75 2.25])
...
for i = 1:length(animals)
    plot([1 2], [probStayPre_l(i) probStayPost_l(i)], '-', 'linewidth', 2, 'Color', colors(i,:))
end
xticks([1 2]); xticklabels({[pre], [post]})
xlim([0.75 2.25])
