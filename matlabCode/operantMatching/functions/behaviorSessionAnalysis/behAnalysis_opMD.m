function behAnalysis_opMD(sessionName, coupledFlag, saveFigFlag, lickFlag)
...
glm_rwdANDnoRwd = fitglm([rwdMatx; noRwdMatx]', allChoice_R, 'distribution','binomial','link','logit');
rsq = num2str(round(glm_rwdANDnoRwd.Rsquared.Adjusted*100)/100);
