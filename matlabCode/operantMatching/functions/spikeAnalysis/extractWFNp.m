...
if plotFlag
    ...
    for j = 1:length(optoInd)
        ...
        saveFigurePDF(gcf,[savePath unitID '_optoTaggedOnly.pdf'])
        % close all
    end
    %% save files
    ...
    for j = 1:length(allOptoUnits)
        ...
        unitID = unitID{1};
        currFileInd = contains(allFiles, [unitID '_optoTaggedOnly']);
