function [guessTR,guessE,postliks,logliks] = hmmtrainPrior(seqs,guessTR,guessE,varargin)
...
%
%       seq1 = hmmgenerate(100,tr,e); seq2 = hmmgenerate(200,tr,e); seqs =
%       {seq1,seq2}; [estTR, estE] = hmmtrain(seqs,tr,e);
%
...
%%            
    ...
    %store value
    Es{1,iteration} = guessE;
    TRs{1,iteration} = guessTR;
    logliks(iteration) = loglik;
    postliks(iteration) = postlik;
