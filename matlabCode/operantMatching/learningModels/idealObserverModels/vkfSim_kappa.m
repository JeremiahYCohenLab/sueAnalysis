function [s, outcome, choice, pRight, blockProbs, blockSwitch] = vkfSim_kappa(varargin)
...
for t = 1:numT
    % Select action
    mDiff = m(t, 2) -  m(t, 1);
    pRight(t) = logistic(beta*mDiff + kappa*prevChoice(t));
