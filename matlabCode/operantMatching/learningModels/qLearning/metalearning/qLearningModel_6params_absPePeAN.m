function [LH, probChoice, Q, pe, pePe, aN, peBar] = qLearningModel_6params_absPePeAN(startValues, choice, outcome)
...
for t = 1 : (trials-1)
    if choice(t, 1) == 1 % right choice
        ...
        pePe(t) = abs(abs(pe(t)) - peBar(t));
        aN(t+1) = pePe(t) * aNscale + aNmin;
        if pe(t) < 0
