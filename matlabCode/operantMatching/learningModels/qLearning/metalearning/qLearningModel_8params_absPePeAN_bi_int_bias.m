function [LH, probChoice, Q, pe, pePe, aN, peBar] = qLearningModel_8params_absPePeAN_bi_int_bias(startValues, choice, outcome)
...
for t = 1 : trials
    if choice(t, 1) == 1 % right choice
        ...
        aN(t+1) = v * (pePe(t) * aNscale + aNmin) + (1 - v) * aN(t);
        if aN(t+1) < 0
            aN(t+1) = 0;
        end
        if pe(t) < 0
