function [LH, probChoice, Q, pe, beta, R, peBar] = qLearningModel_8params_rBeta_pePeAN(startValues, choice, outcome)
...
peBar = peBar(2:end);
peBar(trials) = peBar(end) + aPE * (abs(pe(end)) - peBar(end));
