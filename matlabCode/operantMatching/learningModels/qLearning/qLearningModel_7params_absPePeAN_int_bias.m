function [LH, probChoice, Q, pe, pePe, aN, peBar] = qLearningModel_7params_absPePeAN_int_bias(startValues, choice, outcome)
...
% Call softmax  rule
probChoice = logistic(beta*(Q(:, 2)-Q(:, 1)) + bias); % p(right choice)
