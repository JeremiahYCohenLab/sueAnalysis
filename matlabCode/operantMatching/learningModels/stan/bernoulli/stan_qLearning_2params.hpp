...
namespace stan_qLearning_2params_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper/Documents/gitHubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/bernoulli/stan_qLearning_2params.stan");
    reader.add_event(116, 114, "end", "C:/Users/cooper/Documents/gitHubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/bernoulli/stan_qLearning_2params.stan");
    return reader;
}

class stan_qLearning_2params_model
  : public stan::model::model_base_crtp<stan_qLearning_2params_model> {
private:
        int N;
        int T;
        ...
        vector_d initQ;
public:
    stan_qLearning_2params_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_2params_model_namespace::stan_qLearning_2params_model";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("mu_p", "2", 2);
        context__.validate_dims("parameter initialization", "mu_p", "vector_d", context__.to_vec(2));
        Eigen::Matrix<double, Eigen::Dynamic, 1> mu_p(2);
        size_t mu_p_j_1_max__ = 2;
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(beta, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            (Phi_approx((get_base1(mu_p, 2, "mu_p", 1) + (get_base1(sigma, 2, "sigma", 1) * get_base1(beta_pr, n, "beta_pr", 1)))) * 10), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "stan_qLearning_2params_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning

        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> mu_p = in__.vector_constrain(2);
        size_t mu_p_j_1_max__ = 2;
        for (size_t j_1__ = 0; j_1__ < mu_p_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "stan_qLearning_2params_model";
    }
...
typedef stan_qLearning_2params_model_namespace::stan_qLearning_2params_model stan_model;
