...
// Transform session-level raw parameters
  ...
  for (n in 1:N) {
    ...
    diff[n] = Phi_approx(mu_p[5] + sigma[5] * diff_pr[n]) - 0.8;
  }
}
model {
  // Hyperparameters
