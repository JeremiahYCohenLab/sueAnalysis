...
namespace stan_qLearning_5params_k_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/bernoulli/stan_qLearning_5params_k.stan");
    reader.add_event(160, 160, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/bernoulli/stan_qLearning_5params_k.stan");
    return reader;
}

class stan_qLearning_5params_k_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_5params_k_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_5params_k_model_namespace::stan_qLearning_5params_k_model";
    ...
    ~stan_qLearning_5params_k_model() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_5params_k_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,n,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(get_base1_lhs(get_base1_lhs(y_pred,n,"y_pred",1),t,"y_pred",2), inv_logit(((get_base1(beta,n,"beta",1) * get_base1(Qdiff,t,"Qdiff",1)) + (get_base1(k,n,"k",1) * prevChoice))));
    ...
    static std::string model_name() {
        return "stan_qLearning_5params_k_model";
    }
...
typedef stan_qLearning_5params_k_model_namespace::stan_qLearning_5params_k_model stan_model;
