...
namespace stan_qLearning_5params_pePeAN_noScale_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/bernoulli/stan_qLearning_5params_pePeAN_noScale.stan");
    reader.add_event(161, 161, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/bernoulli/stan_qLearning_5params_pePeAN_noScale.stan");
    return reader;
}

class stan_qLearning_5params_pePeAN_noScale_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_5params_pePeAN_noScale_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_5params_pePeAN_noScale_model_namespace::stan_qLearning_5params_pePeAN_noScale_model";
        ...
        try {
            ...
            validate_non_negative_index("aNstart_pr", "N", N);
            num_params_r__ += N;
    ...
    ~stan_qLearning_5params_pePeAN_noScale_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("aNstart_pr")))
            throw std::runtime_error("variable aNstart_pr missing");
        vals_r__ = context__.vals_r("aNstart_pr");
        pos__ = 0U;
        validate_non_negative_index("aNstart_pr", "N", N);
        context__.validate_dims("initialization", "aNstart_pr", "vector_d", context__.to_vec(N));
        vector_d aNstart_pr(static_cast<Eigen::VectorXd::Index>(N));
        for (int j1__ = 0U; j1__ < N; ++j1__)
            aNstart_pr(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(aNstart_pr);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable aNstart_pr: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  aNstart_pr;
            (void) aNstart_pr;  // dummy to suppress unused var warning
            if (jacobian__)
                aNstart_pr = in__.vector_constrain(N,lp__);
            else
                aNstart_pr = in__.vector_constrain(N);
            ...
            validate_non_negative_index("aNstart", "N", N);
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  aNstart(static_cast<Eigen::VectorXd::Index>(N));
            (void) aNstart;  // dummy to suppress unused var warning

            stan::math::initialize(aNstart, DUMMY_VAR__);
            stan::math::fill(aNstart,DUMMY_VAR__);
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::math::assign(get_base1_lhs(aNstart,n,"aNstart",1), Phi_approx((get_base1(mu_p,1,"mu_p",1) + (get_base1(sigma,1,"sigma",1) * get_base1(aNstart_pr,n,"aNstart_pr",1)))));
                ...
                stan::math::assign(get_base1_lhs(aPE,n,"aPE",1), Phi_approx((get_base1(mu_p,4,"mu_p",1) + (get_base1(sigma,4,"sigma",1) * get_base1(aPE_pr,n,"aPE_pr",1)))));
                current_statement_begin__ = 39;
                stan::math::assign(get_base1_lhs(beta,n,"beta",1), (Phi_approx((get_base1(mu_p,5,"mu_p",1) + (get_base1(sigma,5,"sigma",1) * get_base1(beta_pr,n,"beta_pr",1)))) * 10));
            }

            // validate transformed parameters
            for (int i0__ = 0; i0__ < N; ++i0__) {
                if (stan::math::is_uninitialized(aNstart(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: aNstart" << '[' << i0__ << ']';
            ...
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 28;
            check_greater_or_equal(function__,"aNstart",aNstart,0);
            check_less_or_equal(function__,"aNstart",aNstart,1);
            current_statement_begin__ = 29;
            ...
            lp_accum__.add(normal_log<propto__>(aNstart_pr, 0, 1));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::math::assign(aN, get_base1(aNstart,n,"aNstart",1));
                ...
                for (int t = 1; t <= get_base1(Tsesh,n,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(aN, (aN + (get_base1(aPE,n,"aPE",1) * (stan::math::abs(PE) - peBar))));
                }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_5params_pePeAN_noScale_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector_d mu_p = in__.vector_constrain(5);
        vector_d sigma = in__.vector_lb_constrain(0,5);
        vector_d aNstart_pr = in__.vector_constrain(N);
        ...
        vector_d beta_pr = in__.vector_constrain(N);
            ...
            vars__.push_back(aNstart_pr[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
        ...
        try {
            ...
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            vars__.push_back(aNstart[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            ...
            local_scalar_t__ mu_aNstart;
            (void) mu_aNstart;  // dummy to suppress unused var warning

            stan::math::initialize(mu_aNstart, DUMMY_VAR__);
            stan::math::fill(mu_aNstart,DUMMY_VAR__);
            ...
            stan::math::assign(mu_aNstart, Phi_approx(get_base1(mu_p,1,"mu_p",1)));
            ...
            current_statement_begin__ = 93;
            check_greater_or_equal(function__,"mu_aNstart",mu_aNstart,0);
            check_less_or_equal(function__,"mu_aNstart",mu_aNstart,1);
            current_statement_begin__ = 94;
    ...
    static std::string model_name() {
        return "stan_qLearning_5params_pePeAN_noScale_model";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "aNstart_pr" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
        ...
        if (include_tparams__) {
            for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "aNstart" << '.' << k_0__;
                param_names__.push_back(param_name_stream__.str());
            }
            for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
                param_name_stream__.str(std::string());
        ...
        if (!include_gqs__) return;
        param_name_stream__.str(std::string());
        param_name_stream__ << "mu_aNstart";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
...
typedef stan_qLearning_5params_pePeAN_noScale_model_namespace::stan_qLearning_5params_pePeAN_noScale_model stan_model;
