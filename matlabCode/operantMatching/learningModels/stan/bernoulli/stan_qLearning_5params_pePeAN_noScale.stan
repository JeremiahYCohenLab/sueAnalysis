...
transformed parameters {
  ...
  vector<lower=0, upper=1>[N] aNstart;
  ...
  for (n in 1:N) {
    aNstart[n] = Phi_approx(mu_p[1] + sigma[1] * aNstart_pr[n]);
...
generated quantities {
  ...
  real<lower=0, upper=1> mu_aNstart;
