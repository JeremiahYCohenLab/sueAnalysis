...
namespace stan_qLearning_5params_rBeta_scale_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/bernoulli/stan_qLearning_5params_rBeta_scale.stan");
    reader.add_event(168, 168, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/bernoulli/stan_qLearning_5params_rBeta_scale.stan");
    return reader;
}

class stan_qLearning_5params_rBeta_scale_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_5params_rBeta_scale_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_5params_rBeta_scale_model_namespace::stan_qLearning_5params_rBeta_scale_model";
    ...
    ~stan_qLearning_5params_rBeta_scale_model() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(get_base1_lhs(beta,1,"beta",1), 0);
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    if (as_bool(logical_lt(t,get_base1(Tsesh,i,"Tsesh",1)))) {
                        ...
                        stan::math::assign(get_base1_lhs(beta,(t + 1),"beta",1), (R * get_base1(betaScale,i,"betaScale",1)));
                    }
                }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_5params_rBeta_scale_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(get_base1_lhs(get_base1_lhs(y_pred,i,"y_pred",1),t,"y_pred",2), categorical_rng(softmax(multiply(get_base1(beta,t,"beta",1),Q)), base_rng__));
    ...
    static std::string model_name() {
        return "stan_qLearning_5params_rBeta_scale_model";
    }
...
typedef stan_qLearning_5params_rBeta_scale_model_namespace::stan_qLearning_5params_rBeta_scale_model stan_model;
