...
namespace stan_qLearning_6params_pePeBeta_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/bernoulli/stan_qLearning_6params_pePeBeta.stan");
    reader.add_event(176, 176, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/bernoulli/stan_qLearning_6params_pePeBeta.stan");
    return reader;
}

class stan_qLearning_6params_pePeBeta_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_6params_pePeBeta_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_6params_pePeBeta_model_namespace::stan_qLearning_6params_pePeBeta_model";
    ...
    ~stan_qLearning_6params_pePeBeta_model() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(get_base1_lhs(aPE,i,"aPE",1), Phi_approx((get_base1(mu_p,4,"mu_p",1) + (get_base1(sigma,4,"sigma",1) * get_base1(aPE_pr,i,"aPE_pr",1)))));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                validate_non_negative_index("beta", "get_base1(Tsesh,i,\"Tsesh\",1)", get_base1(Tsesh,i,"Tsesh",1));
                Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  beta(static_cast<Eigen::VectorXd::Index>(get_base1(Tsesh,i,"Tsesh",1)));
                ...
                stan::math::assign(get_base1_lhs(beta,1,"beta",1), get_base1(betaMin,i,"betaMin",1));
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    lp_accum__.add(bernoulli_logit_log<propto__>(get_base1(get_base1(choice,i,"choice",1),t,"choice",2), (get_base1(beta,t,"beta",1) * get_base1(Qdiff,t,"Qdiff",1))));
                    ...
                    if (as_bool(logical_lt(t,get_base1(Tsesh,i,"Tsesh",1)))) {

                        current_statement_begin__ = 94;
                        stan::math::assign(get_base1_lhs(beta,(t + 1),"beta",1), (get_base1(betaMin,i,"betaMin",1) + (peBar * get_base1(betaScale,i,"betaScale",1))));
                    }
                }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_6params_pePeBeta_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(get_base1_lhs(log_lik,i,"log_lik",1), (get_base1(log_lik,i,"log_lik",1) + bernoulli_logit_log(get_base1(get_base1(choice,i,"choice",1),t,"choice",2),(get_base1(beta,t,"beta",1) * get_base1(Qdiff,t,"Qdiff",1)))));
    ...
    static std::string model_name() {
        return "stan_qLearning_6params_pePeBeta_model";
    }
...
typedef stan_qLearning_6params_pePeBeta_model_namespace::stan_qLearning_6params_pePeBeta_model stan_model;
