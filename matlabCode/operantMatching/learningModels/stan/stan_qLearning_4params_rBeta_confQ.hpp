...
namespace stan_qLearning_4params_rBeta_confQ_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_4params_rBeta_confQ.stan");
    reader.add_event(151, 151, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_4params_rBeta_confQ.stan");
    return reader;
}

class stan_qLearning_4params_rBeta_confQ_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_4params_rBeta_confQ_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_4params_rBeta_confQ_model_namespace::stan_qLearning_4params_rBeta_confQ_model";
    ...
    ~stan_qLearning_4params_rBeta_confQ_model() { }
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(R, stan::math::abs((get_base1(Q,1,"Q",1) - get_base1(Q,2,"Q",1))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_4params_rBeta_confQ_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "stan_qLearning_4params_rBeta_confQ_model";
    }
...
typedef stan_qLearning_4params_rBeta_confQ_model_namespace::stan_qLearning_4params_rBeta_confQ_model stan_model;
