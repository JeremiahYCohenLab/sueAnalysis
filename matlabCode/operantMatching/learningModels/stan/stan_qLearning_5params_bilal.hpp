...
namespace stan_qLearning_5params_bilal_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_bilal.stan");
    reader.add_event(147, 147, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_bilal.stan");
    return reader;
}

class stan_qLearning_5params_bilal_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initCP;
public:
    stan_qLearning_5params_bilal_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_5params_bilal_model_namespace::stan_qLearning_5params_bilal_model";
    ...
    ~stan_qLearning_5params_bilal_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("bias_pr")))
            throw std::runtime_error("variable bias_pr missing");
        vals_r__ = context__.vals_r("bias_pr");
        pos__ = 0U;
        validate_non_negative_index("bias_pr", "N", N);
        context__.validate_dims("initialization", "bias_pr", "vector_d", context__.to_vec(N));
        vector_d bias_pr(static_cast<Eigen::VectorXd::Index>(N));
        for (int j1__ = 0U; j1__ < N; ++j1__)
            bias_pr(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(bias_pr);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable bias_pr: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  bias(static_cast<Eigen::VectorXd::Index>(N));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::math::assign(get_base1_lhs(alpha,n,"alpha",1), Phi_approx((get_base1(mu_p,1,"mu_p",1) + (get_base1(sigma,1,"sigma",1) * get_base1(alpha_pr,n,"alpha_pr",1)))));
                current_statement_begin__ = 37;
                stan::math::assign(get_base1_lhs(aF,n,"aF",1), Phi_approx((get_base1(mu_p,2,"mu_p",1) + (get_base1(sigma,2,"sigma",1) * get_base1(aF_pr,n,"aF_pr",1)))));
                current_statement_begin__ = 38;
                stan::math::assign(get_base1_lhs(beta,n,"beta",1), (Phi_approx((get_base1(mu_p,3,"mu_p",1) + (get_base1(sigma,3,"sigma",1) * get_base1(beta_pr,n,"beta_pr",1)))) * 100));
                current_statement_begin__ = 39;
                stan::math::assign(get_base1_lhs(k,n,"k",1), ((Phi_approx((get_base1(mu_p,4,"mu_p",1) + (get_base1(sigma,4,"sigma",1) * get_base1(k_pr,n,"k_pr",1)))) * 10) - 5));
                current_statement_begin__ = 40;
                stan::math::assign(get_base1_lhs(bias,n,"bias",1), ((Phi_approx(get_base1(bias_pr,n,"bias_pr",1)) * 10) - 5));
            }
            ...
            for (int i0__ = 0; i0__ < N; ++i0__) {
                if (stan::math::is_uninitialized(bias(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: bias" << '[' << i0__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
            ...
            check_less_or_equal(function__,"beta",beta,100);
            current_statement_begin__ = 32;
            check_greater_or_equal(function__,"k",k,-(5));
            check_less_or_equal(function__,"k",k,5);
            current_statement_begin__ = 33;
            check_greater_or_equal(function__,"bias",bias,-(5));
            check_less_or_equal(function__,"bias",bias,5);
            ...
            lp_accum__.add(normal_log<propto__>(beta_pr, 0, 0.0001));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  cP(static_cast<Eigen::VectorXd::Index>(2));
                ...
                for (int t = 1; t <= get_base1(Tsesh,n,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(get_base1_lhs(cP,2,"cP",1), (1 / (1 + stan::math::exp(-((((get_base1(beta,n,"beta",1) * (get_base1(Q,2,"Q",1) - get_base1(Q,1,"Q",1))) + (get_base1(k,n,"k",1) * prevChoice)) + get_base1(bias,n,"bias",1)))))));
                    current_statement_begin__ = 69;
                    stan::math::assign(get_base1_lhs(cP,1,"cP",1), (1 - get_base1(cP,2,"cP",1)));
                    current_statement_begin__ = 70;
                    lp_accum__.add(categorical_log<propto__>(get_base1(get_base1(choice,n,"choice",1),t,"choice",2), cP));
                    current_statement_begin__ = 73;
                    stan::math::assign(PE, (get_base1(get_base1(outcome,n,"outcome",1),t,"outcome",2) - get_base1(Q,get_base1(get_base1(choice,n,"choice",1),t,"choice",2),"Q",1)));
                    current_statement_begin__ = 75;
                    stan::math::assign(get_base1_lhs(Q,get_base1(get_base1(choice,n,"choice",1),t,"choice",2),"Q",1), ((get_base1(Q,get_base1(get_base1(choice,n,"choice",1),t,"choice",2),"Q",1) * get_base1(aF,n,"aF",1)) + (get_base1(alpha,n,"alpha",1) * PE)));
                    current_statement_begin__ = 76;
                    if (as_bool(logical_eq(get_base1(get_base1(choice,n,"choice",1),t,"choice",2),2))) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_5params_bilal_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        vector_d bias_pr = in__.vector_constrain(N);
            ...
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            vars__.push_back(bias_pr[k_0__]);
            }
        ...
        try {
            ...
            stan::math::assign(mu_alpha, Phi_approx(get_base1(mu_p,1,"mu_p",1)));
            current_statement_begin__ = 107;
            stan::math::assign(mu_aF, Phi_approx(get_base1(mu_p,2,"mu_p",1)));
            current_statement_begin__ = 108;
            stan::math::assign(mu_beta, (Phi_approx(get_base1(mu_p,3,"mu_p",1)) * 100));
            current_statement_begin__ = 109;
            stan::math::assign(mu_k, ((Phi_approx(get_base1(mu_p,4,"mu_p",1)) * 10) - 5));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,n,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(get_base1_lhs(log_lik,n,"log_lik",1), (get_base1(log_lik,n,"log_lik",1) + categorical_log(get_base1(get_base1(choice,n,"choice",1),t,"choice",2),cP)));
                    current_statement_begin__ = 131;
                    stan::math::assign(get_base1_lhs(get_base1_lhs(y_pred,n,"y_pred",1),t,"y_pred",2), categorical_rng(cP, base_rng__));
            ...
            check_less_or_equal(function__,"mu_beta",mu_beta,100);
            current_statement_begin__ = 91;
    ...
    static std::string model_name() {
        return "stan_qLearning_5params_bilal_model";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "bias_pr" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
...
typedef stan_qLearning_5params_bilal_model_namespace::stan_qLearning_5params_bilal_model stan_model;
