...
namespace stan_qLearning_5params_kappa_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_kappa.stan");
    reader.add_event(161, 161, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_kappa.stan");
    return reader;
}

class stan_qLearning_5params_kappa_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initCP;
public:
    stan_qLearning_5params_kappa_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_5params_kappa_model_namespace::stan_qLearning_5params_kappa_model";
    ...
    ~stan_qLearning_5params_kappa_model() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(get_base1_lhs(beta,i,"beta",1), (Phi_approx((get_base1(mu_p,4,"mu_p",1) + (get_base1(sigma,4,"sigma",1) * get_base1(beta_pr,i,"beta_pr",1)))) * 30));
                current_statement_begin__ = 40;
                stan::math::assign(get_base1_lhs(k,i,"k",1), (-(1) + (2 * Phi_approx((get_base1(mu_p,5,"mu_p",1) + (get_base1(sigma,5,"sigma",1) * get_base1(k_pr,i,"k_pr",1)))))));
            }
            ...
            check_less_or_equal(function__,"beta",beta,30);
            current_statement_begin__ = 33;
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(get_base1_lhs(cP,1,"cP",1), (1 / (1 + stan::math::exp((-(get_base1(beta,i,"beta",1)) * ((get_base1(Q,1,"Q",1) - get_base1(Q,2,"Q",1)) + (get_base1(k,i,"k",1) * prevChoice)))))));
                    current_statement_begin__ = 69;
                    stan::math::assign(get_base1_lhs(cP,2,"cP",1), (1 - get_base1(cP,1,"cP",1)));
                    current_statement_begin__ = 70;
                    lp_accum__.add(categorical_log<propto__>(get_base1(get_base1(choice,i,"choice",1),t,"choice",2), cP));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_5params_kappa_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(mu_beta, (Phi_approx(get_base1(mu_p,4,"mu_p",1)) * 30));
            current_statement_begin__ = 117;
            stan::math::assign(mu_k, (-(1) + (2 * Phi_approx(get_base1(mu_p,5,"mu_p",1)))));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(get_base1_lhs(log_lik,i,"log_lik",1), (get_base1(log_lik,i,"log_lik",1) + categorical_log(get_base1(get_base1(choice,i,"choice",1),t,"choice",2),cP)));
                    current_statement_begin__ = 139;
                    stan::math::assign(get_base1_lhs(get_base1_lhs(y_pred,i,"y_pred",1),t,"y_pred",2), categorical_rng(cP, base_rng__));
            ...
            check_less_or_equal(function__,"mu_beta",mu_beta,30);
            current_statement_begin__ = 98;
            check_greater_or_equal(function__,"mu_k",mu_k,-(1));
    ...
    static std::string model_name() {
        return "stan_qLearning_5params_kappa_model";
    }
...
typedef stan_qLearning_5params_kappa_model_namespace::stan_qLearning_5params_kappa_model stan_model;
