...
namespace stan_qLearning_5params_opponency_fixedParams_aF_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_opponency_fixedParams_aF.stan");
    reader.add_event(142, 142, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_opponency_fixedParams_aF.stan");
    return reader;
}

class stan_qLearning_5params_opponency_fixedParams_aF_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    double v;
public:
    stan_qLearning_5params_opponency_fixedParams_aF_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_5params_opponency_fixedParams_aF_model_namespace::stan_qLearning_5params_opponency_fixedParams_aF_model";
        ...
        try {
            ...
            stan::math::assign(beta, get_base1(params,3,"params",1));
            current_statement_begin__ = 24;
            stan::math::assign(v, get_base1(params,4,"params",1));
    ...
    ~stan_qLearning_5params_opponency_fixedParams_aF_model() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(get_base1_lhs(aF,i,"aF",1), Phi_approx((get_base1(mu_p,1,"mu_p",1) + (get_base1(sigma,1,"sigma",1) * get_base1(aF_pr,i,"aF_pr",1)))));
            }
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(rBar, ((v * get_base1(get_base1(outcome,i,"outcome",1),t,"outcome",2)) + ((1 - v) * rBar)));
                }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_5params_opponency_fixedParams_aF_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(mu_aF, Phi_approx(get_base1(mu_p,1,"mu_p",1)));
    ...
    static std::string model_name() {
        return "stan_qLearning_5params_opponency_fixedParams_aF_model";
    }
...
typedef stan_qLearning_5params_opponency_fixedParams_aF_model_namespace::stan_qLearning_5params_opponency_fixedParams_aF_model stan_model;
