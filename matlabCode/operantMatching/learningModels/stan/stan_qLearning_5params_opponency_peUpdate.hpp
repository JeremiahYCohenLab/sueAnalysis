...
namespace stan_qLearning_5params_opponency_peUpdate_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_opponency_peUpdate.stan");
    reader.add_event(149, 149, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_opponency_peUpdate.stan");
    return reader;
}

class stan_qLearning_5params_opponency_peUpdate_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_5params_opponency_peUpdate_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_5params_opponency_peUpdate_model_namespace::stan_qLearning_5params_opponency_peUpdate_model";
    ...
    ~stan_qLearning_5params_opponency_peUpdate_model() { }
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(rBar, ((get_base1(v,i,"v",1) * (PE + rBar)) + ((1 - get_base1(v,i,"v",1)) * rBar)));
                }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_5params_opponency_peUpdate_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "stan_qLearning_5params_opponency_peUpdate_model";
    }
...
typedef stan_qLearning_5params_opponency_peUpdate_model_namespace::stan_qLearning_5params_opponency_peUpdate_model stan_model;
