...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(157, 157, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_opponency_rBarStart.stan");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("rBarS_pr", "N", N);
            num_params_r__ += N;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("rBarS_pr")))
            throw std::runtime_error("variable rBarS_pr missing");
        vals_r__ = context__.vals_r("rBarS_pr");
        pos__ = 0U;
        validate_non_negative_index("rBarS_pr", "N", N);
        context__.validate_dims("initialization", "rBarS_pr", "vector_d", context__.to_vec(N));
        vector_d rBarS_pr(static_cast<Eigen::VectorXd::Index>(N));
        for (int j1__ = 0U; j1__ < N; ++j1__)
            rBarS_pr(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(rBarS_pr);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable rBarS_pr: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  rBarS_pr;
            (void) rBarS_pr;  // dummy to suppress unused var warning
            if (jacobian__)
                rBarS_pr = in__.vector_constrain(N,lp__);
            else
                rBarS_pr = in__.vector_constrain(N);
            ...
            validate_non_negative_index("rBarS", "N", N);
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  rBarS(static_cast<Eigen::VectorXd::Index>(N));
            (void) rBarS;  // dummy to suppress unused var warning

            stan::math::initialize(rBarS, DUMMY_VAR__);
            stan::math::fill(rBarS,DUMMY_VAR__);
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(get_base1_lhs(rBarS,i,"rBarS",1), Phi_approx((get_base1(mu_p,6,"mu_p",1) + (get_base1(sigma,6,"sigma",1) * get_base1(rBarS_pr,i,"rBarS_pr",1)))));
            }
            ...
            for (int i0__ = 0; i0__ < N; ++i0__) {
                if (stan::math::is_uninitialized(rBarS(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: rBarS" << '[' << i0__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
            ...
            current_statement_begin__ = 33;
            check_greater_or_equal(function__,"rBarS",rBarS,0);
            check_less_or_equal(function__,"rBarS",rBarS,1);
            ...
            lp_accum__.add(normal_log<propto__>(rBarS_pr, 0, 1));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(rBar, get_base1(rBarS,i,"rBarS",1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vector_d rBarS_pr = in__.vector_constrain(N);
            ...
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            vars__.push_back(rBarS_pr[k_0__]);
            }
        ...
        try {
            ...
            local_scalar_t__ mu_rBarS;
            (void) mu_rBarS;  // dummy to suppress unused var warning

            stan::math::initialize(mu_rBarS, DUMMY_VAR__);
            stan::math::fill(mu_rBarS,DUMMY_VAR__);
            ...
            stan::math::assign(mu_rBarS, Phi_approx(get_base1(mu_p,6,"mu_p",1)));
            ...
            current_statement_begin__ = 97;
            check_greater_or_equal(function__,"mu_rBarS",mu_rBarS,0);
            check_less_or_equal(function__,"mu_rBarS",mu_rBarS,1);
            current_statement_begin__ = 100;
            current_statement_begin__ = 103;
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "rBarS_pr" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        ...
        if (include_tparams__) {
            ...
            for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "rBarS" << '.' << k_0__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
