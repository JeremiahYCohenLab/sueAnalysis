...
namespace stan_qLearning_5params_opponency_strongPriors_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_opponency_strongPriors.stan");
    reader.add_event(150, 150, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_opponency_strongPriors.stan");
    return reader;
}

class stan_qLearning_5params_opponency_strongPriors_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_5params_opponency_strongPriors_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_5params_opponency_strongPriors_model_namespace::stan_qLearning_5params_opponency_strongPriors_model";
    ...
    ~stan_qLearning_5params_opponency_strongPriors_model() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(v_pr, 0, 0.10000000000000001));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_5params_opponency_strongPriors_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "stan_qLearning_5params_opponency_strongPriors_model";
    }
...
typedef stan_qLearning_5params_opponency_strongPriors_model_namespace::stan_qLearning_5params_opponency_strongPriors_model stan_model;
