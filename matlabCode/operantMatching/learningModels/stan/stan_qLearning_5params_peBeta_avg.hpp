...
namespace stan_qLearning_5params_peBeta_avg_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_peBeta_avg.stan");
    reader.add_event(157, 157, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_peBeta_avg.stan");
    return reader;
}

class stan_qLearning_5params_peBeta_avg_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_5params_peBeta_avg_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_5params_peBeta_avg_model_namespace::stan_qLearning_5params_peBeta_avg_model";
    ...
    ~stan_qLearning_5params_peBeta_avg_model() { }
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(R, ((get_base1(v,i,"v",1) * stan::math::abs(PE)) + ((1 - get_base1(v,i,"v",1)) * R)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_5params_peBeta_avg_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "stan_qLearning_5params_peBeta_avg_model";
    }
...
typedef stan_qLearning_5params_peBeta_avg_model_namespace::stan_qLearning_5params_peBeta_avg_model stan_model;
