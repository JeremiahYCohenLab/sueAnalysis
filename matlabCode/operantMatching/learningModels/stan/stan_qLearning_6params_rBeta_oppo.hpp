...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_6params_rBeta_oppo.stan");
    reader.add_event(162, 162, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_6params_rBeta_oppo.stan");
    return reader;
}

class stan_qLearning_6params_rBeta_oppo_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(PE, ((get_base1(get_base1(outcome,i,"outcome",1),t,"outcome",2) - get_base1(Q,get_base1(get_base1(choice,i,"choice",1),t,"choice",2),"Q",1)) - R));
