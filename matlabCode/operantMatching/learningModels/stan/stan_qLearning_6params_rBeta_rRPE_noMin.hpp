...
namespace stan_qLearning_6params_rBeta_rRPE_noMin_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_6params_rBeta_rRPE_noMin.stan");
    reader.add_event(169, 169, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_6params_rBeta_rRPE_noMin.stan");
    return reader;
}

class stan_qLearning_6params_rBeta_rRPE_noMin_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_6params_rBeta_rRPE_noMin_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_6params_rBeta_rRPE_noMin_model_namespace::stan_qLearning_6params_rBeta_rRPE_noMin_model";
        ...
        try {
            ...
            validate_non_negative_index("rRate_pr", "N", N);
            num_params_r__ += N;
            current_statement_begin__ = 23;
            validate_non_negative_index("betaStart_pr", "N", N);
            num_params_r__ += N;
    ...
    ~stan_qLearning_6params_rBeta_rRPE_noMin_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("rRate_pr")))
            throw std::runtime_error("variable rRate_pr missing");
        vals_r__ = context__.vals_r("rRate_pr");
        pos__ = 0U;
        validate_non_negative_index("rRate_pr", "N", N);
        context__.validate_dims("initialization", "rRate_pr", "vector_d", context__.to_vec(N));
        vector_d rRate_pr(static_cast<Eigen::VectorXd::Index>(N));
        for (int j1__ = 0U; j1__ < N; ++j1__)
            rRate_pr(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(rRate_pr);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable rRate_pr: ") + e.what());
        }

        if (!(context__.contains_r("betaStart_pr")))
            throw std::runtime_error("variable betaStart_pr missing");
        vals_r__ = context__.vals_r("betaStart_pr");
        pos__ = 0U;
        validate_non_negative_index("betaStart_pr", "N", N);
        context__.validate_dims("initialization", "betaStart_pr", "vector_d", context__.to_vec(N));
        vector_d betaStart_pr(static_cast<Eigen::VectorXd::Index>(N));
        for (int j1__ = 0U; j1__ < N; ++j1__)
            betaStart_pr(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(betaStart_pr);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable betaStart_pr: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  rRate_pr;
            (void) rRate_pr;  // dummy to suppress unused var warning
            if (jacobian__)
                rRate_pr = in__.vector_constrain(N,lp__);
            else
                rRate_pr = in__.vector_constrain(N);

            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  betaStart_pr;
            (void) betaStart_pr;  // dummy to suppress unused var warning
            if (jacobian__)
                betaStart_pr = in__.vector_constrain(N,lp__);
            else
                betaStart_pr = in__.vector_constrain(N);
            ...
            validate_non_negative_index("rRate", "N", N);
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  rRate(static_cast<Eigen::VectorXd::Index>(N));
            (void) rRate;  // dummy to suppress unused var warning

            stan::math::initialize(rRate, DUMMY_VAR__);
            stan::math::fill(rRate,DUMMY_VAR__);
            current_statement_begin__ = 33;
            validate_non_negative_index("betaStart", "N", N);
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  betaStart(static_cast<Eigen::VectorXd::Index>(N));
            (void) betaStart;  // dummy to suppress unused var warning

            stan::math::initialize(betaStart, DUMMY_VAR__);
            stan::math::fill(betaStart,DUMMY_VAR__);
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(get_base1_lhs(rRate,i,"rRate",1), Phi_approx((get_base1(mu_p,4,"mu_p",1) + (get_base1(sigma,4,"sigma",1) * get_base1(rRate_pr,i,"rRate_pr",1)))));
                current_statement_begin__ = 41;
                stan::math::assign(get_base1_lhs(betaStart,i,"betaStart",1), (Phi_approx((get_base1(mu_p,5,"mu_p",1) + (get_base1(sigma,5,"sigma",1) * get_base1(betaStart_pr,i,"betaStart_pr",1)))) * 20));
                current_statement_begin__ = 42;
                stan::math::assign(get_base1_lhs(betaScale,i,"betaScale",1), (Phi_approx((get_base1(mu_p,6,"mu_p",1) + (get_base1(sigma,6,"sigma",1) * get_base1(betaScale_pr,i,"betaScale_pr",1)))) * 20));
            }
            ...
            for (int i0__ = 0; i0__ < N; ++i0__) {
                if (stan::math::is_uninitialized(rRate(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: rRate" << '[' << i0__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
            for (int i0__ = 0; i0__ < N; ++i0__) {
                if (stan::math::is_uninitialized(betaStart(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: betaStart" << '[' << i0__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
            for (int i0__ = 0; i0__ < N; ++i0__) {
            ...
            current_statement_begin__ = 32;
            check_greater_or_equal(function__,"rRate",rRate,0);
            check_less_or_equal(function__,"rRate",rRate,1);
            current_statement_begin__ = 33;
            check_greater_or_equal(function__,"betaStart",betaStart,0);
            check_less_or_equal(function__,"betaStart",betaStart,20);
            current_statement_begin__ = 34;
            ...
            lp_accum__.add(normal_log<propto__>(rRate_pr, 0, 1));
            current_statement_begin__ = 55;
            lp_accum__.add(normal_log<propto__>(betaStart_pr, 0, 1));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(beta, get_base1(betaStart,i,"betaStart",1));
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(R, (R + (get_base1(rRate,i,"rRate",1) * (get_base1(get_base1(outcome,i,"outcome",1),t,"outcome",2) - R))));
                    current_statement_begin__ = 89;
                    stan::math::assign(beta, (beta + (get_base1(betaScale,i,"betaScale",1) * R)));
                    current_statement_begin__ = 90;
                    if (as_bool(logical_lt(beta,0))) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_6params_rBeta_rRPE_noMin_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        vector_d rRate_pr = in__.vector_constrain(N);
        vector_d betaStart_pr = in__.vector_constrain(N);
        vector_d betaScale_pr = in__.vector_constrain(N);
            ...
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            vars__.push_back(rRate_pr[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            vars__.push_back(betaStart_pr[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
        ...
        try {
            ...
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            vars__.push_back(rRate[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            vars__.push_back(betaStart[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            ...
            local_scalar_t__ mu_rRate;
            (void) mu_rRate;  // dummy to suppress unused var warning

            stan::math::initialize(mu_rRate, DUMMY_VAR__);
            stan::math::fill(mu_rRate,DUMMY_VAR__);
            current_statement_begin__ = 102;
            local_scalar_t__ mu_betaStart;
            (void) mu_betaStart;  // dummy to suppress unused var warning

            stan::math::initialize(mu_betaStart, DUMMY_VAR__);
            stan::math::fill(mu_betaStart,DUMMY_VAR__);
            ...
            stan::math::assign(mu_rRate, Phi_approx(get_base1(mu_p,4,"mu_p",1)));
            current_statement_begin__ = 122;
            stan::math::assign(mu_betaStart, (Phi_approx(get_base1(mu_p,5,"mu_p",1)) * 20));
            current_statement_begin__ = 123;
            stan::math::assign(mu_betaScale, (Phi_approx(get_base1(mu_p,6,"mu_p",1)) * 20));
            ...
            current_statement_begin__ = 101;
            check_greater_or_equal(function__,"mu_rRate",mu_rRate,0);
            check_less_or_equal(function__,"mu_rRate",mu_rRate,20);
            current_statement_begin__ = 102;
            check_greater_or_equal(function__,"mu_betaStart",mu_betaStart,0);
            check_less_or_equal(function__,"mu_betaStart",mu_betaStart,20);
            current_statement_begin__ = 103;
        ...
        vars__.push_back(mu_rRate);
        vars__.push_back(mu_betaStart);
    ...
    static std::string model_name() {
        return "stan_qLearning_6params_rBeta_rRPE_noMin_model";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "rRate_pr" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "betaStart_pr" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
        ...
        if (include_tparams__) {
            ...
            for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "rRate" << '.' << k_0__;
                param_names__.push_back(param_name_stream__.str());
            }
            for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "betaStart" << '.' << k_0__;
                param_names__.push_back(param_name_stream__.str());
            }
            for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
                param_name_stream__.str(std::string());
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "mu_rRate";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "mu_betaStart";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
...
typedef stan_qLearning_6params_rBeta_rRPE_noMin_model_namespace::stan_qLearning_6params_rBeta_rRPE_noMin_model stan_model;
