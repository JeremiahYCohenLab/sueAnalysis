...
namespace stan_qLearning_6params_rBeta_scale_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_6params_rBeta_scale.stan");
    reader.add_event(163, 163, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_6params_rBeta_scale.stan");
    return reader;
}

class stan_qLearning_6params_rBeta_scale_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_6params_rBeta_scale_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_6params_rBeta_scale_model_namespace::stan_qLearning_6params_rBeta_scale_model";
        ...
        try {
            ...
            validate_non_negative_index("betaInit_pr", "N", N);
            num_params_r__ += N;
    ...
    ~stan_qLearning_6params_rBeta_scale_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("betaInit_pr")))
            throw std::runtime_error("variable betaInit_pr missing");
        vals_r__ = context__.vals_r("betaInit_pr");
        pos__ = 0U;
        validate_non_negative_index("betaInit_pr", "N", N);
        context__.validate_dims("initialization", "betaInit_pr", "vector_d", context__.to_vec(N));
        vector_d betaInit_pr(static_cast<Eigen::VectorXd::Index>(N));
        for (int j1__ = 0U; j1__ < N; ++j1__)
            betaInit_pr(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(betaInit_pr);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable betaInit_pr: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  betaInit_pr;
            (void) betaInit_pr;  // dummy to suppress unused var warning
            if (jacobian__)
                betaInit_pr = in__.vector_constrain(N,lp__);
            else
                betaInit_pr = in__.vector_constrain(N);
            ...
            validate_non_negative_index("betaInit", "N", N);
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  betaInit(static_cast<Eigen::VectorXd::Index>(N));
            (void) betaInit;  // dummy to suppress unused var warning

            stan::math::initialize(betaInit, DUMMY_VAR__);
            stan::math::fill(betaInit,DUMMY_VAR__);
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(get_base1_lhs(betaInit,i,"betaInit",1), (Phi_approx((get_base1(mu_p,6,"mu_p",1) + (get_base1(sigma,6,"sigma",1) * get_base1(betaInit_pr,i,"betaInit_pr",1)))) * 20));
            }
            ...
            for (int i0__ = 0; i0__ < N; ++i0__) {
                if (stan::math::is_uninitialized(betaInit(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: betaInit" << '[' << i0__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
            ...
            current_statement_begin__ = 34;
            check_greater_or_equal(function__,"betaInit",betaInit,0);
            check_less_or_equal(function__,"betaInit",betaInit,20);
            ...
            lp_accum__.add(normal_log<propto__>(betaInit_pr, 0, 1));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(beta, get_base1(betaInit,i,"betaInit",1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_6params_rBeta_scale_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        vector_d betaInit_pr = in__.vector_constrain(N);
            ...
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            vars__.push_back(betaInit_pr[k_0__]);
            }
        ...
        try {
            ...
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            vars__.push_back(betaInit[k_0__]);
            }
            }
            ...
            local_scalar_t__ mu_betaInit;
            (void) mu_betaInit;  // dummy to suppress unused var warning

            stan::math::initialize(mu_betaInit, DUMMY_VAR__);
            stan::math::fill(mu_betaInit,DUMMY_VAR__);
            ...
            stan::math::assign(mu_betaInit, (Phi_approx(get_base1(mu_p,6,"mu_p",1)) * 20));
            ...
            current_statement_begin__ = 100;
            check_greater_or_equal(function__,"mu_betaInit",mu_betaInit,0);
            check_less_or_equal(function__,"mu_betaInit",mu_betaInit,20);
            current_statement_begin__ = 103;
            current_statement_begin__ = 106;
    ...
    static std::string model_name() {
        return "stan_qLearning_6params_rBeta_scale_model";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "betaInit_pr" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        ...
        if (include_tparams__) {
            ...
            for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "betaInit" << '.' << k_0__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "mu_betaInit";
        param_names__.push_back(param_name_stream__.str());
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
...
typedef stan_qLearning_6params_rBeta_scale_model_namespace::stan_qLearning_6params_rBeta_scale_model stan_model;
