...
namespace stan_qLearning_6params_rBeta_scale_kappa_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_6params_rBeta_scale_kappa.stan");
    reader.add_event(176, 176, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_6params_rBeta_scale_kappa.stan");
    return reader;
}

class stan_qLearning_6params_rBeta_scale_kappa_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_6params_rBeta_scale_kappa_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_6params_rBeta_scale_kappa_model_namespace::stan_qLearning_6params_rBeta_scale_kappa_model";
    ...
    ~stan_qLearning_6params_rBeta_scale_kappa_model() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(get_base1_lhs(k,i,"k",1), Phi_approx((get_base1(mu_p,6,"mu_p",1) + (get_base1(sigma,6,"sigma",1) * get_base1(k_pr,i,"k_pr",1)))));
            }
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    if (as_bool(logical_eq(t,1))) {
                        ...
                        lp_accum__.add(categorical_logit_log<propto__>(get_base1(get_base1(choice,i,"choice",1),t,"choice",2), add(multiply(beta,Q),(get_base1(k,i,"k",1) * prevChoice))));
                    }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_6params_rBeta_scale_kappa_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(mu_k, Phi_approx(get_base1(mu_p,6,"mu_p",1)));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    if (as_bool(logical_eq(t,1))) {
                        ...
                        stan::math::assign(get_base1_lhs(log_lik,i,"log_lik",1), (get_base1(log_lik,i,"log_lik",1) + categorical_logit_log(get_base1(get_base1(choice,i,"choice",1),t,"choice",2),add(multiply(beta,Q),(get_base1(k,i,"k",1) * prevChoice)))));
                        current_statement_begin__ = 148;
                        stan::math::assign(get_base1_lhs(get_base1_lhs(y_pred,i,"y_pred",1),t,"y_pred",2), categorical_rng(softmax(add(multiply(beta,Q),(get_base1(k,i,"k",1) * prevChoice))), base_rng__));
                    } else {
            ...
            check_less_or_equal(function__,"mu_k",mu_k,20);
            current_statement_begin__ = 109;
            current_statement_begin__ = 112;
    ...
    static std::string model_name() {
        return "stan_qLearning_6params_rBeta_scale_kappa_model";
    }
...
typedef stan_qLearning_6params_rBeta_scale_kappa_model_namespace::stan_qLearning_6params_rBeta_scale_kappa_model stan_model;
