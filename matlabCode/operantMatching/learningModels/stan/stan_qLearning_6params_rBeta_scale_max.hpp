...
namespace stan_qLearning_6params_rBeta_scale_max_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_6params_rBeta_scale_max.stan");
    reader.add_event(163, 163, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_6params_rBeta_scale_max.stan");
    return reader;
}

class stan_qLearning_6params_rBeta_scale_max_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_6params_rBeta_scale_max_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_6params_rBeta_scale_max_model_namespace::stan_qLearning_6params_rBeta_scale_max_model";
    ...
    ~stan_qLearning_6params_rBeta_scale_max_model() { }
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsesh,i,"Tsesh",1); ++t) {
                    ...
                    stan::math::assign(beta, (get_base1(betaMax,i,"betaMax",1) - ((1 - R) * get_base1(betaScale,i,"betaScale",1))));
                }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_6params_rBeta_scale_max_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "stan_qLearning_6params_rBeta_scale_max_model";
    }
...
typedef stan_qLearning_6params_rBeta_scale_max_model_namespace::stan_qLearning_6params_rBeta_scale_max_model stan_model;
