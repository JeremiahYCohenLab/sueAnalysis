function files = checkFiles(xlFile, animal,category)
...
for i = 1:length(dayList)
    ...
    % behavior
    behFile = [dataPath 'behavior' sep sessionName '.asc'];
    if exist(behFile,'file')
        files(i).behavior = 1;
    end
    % pupil
    pupilFile = [dataPath 'pupil' sep sessionName '.avi'];
