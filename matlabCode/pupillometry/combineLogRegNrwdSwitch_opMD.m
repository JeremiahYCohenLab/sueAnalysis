function [glm_rwdLick, stayLickLat, switchLickLat, binSize, timeMax, combinedITIlicks] = combineLogRegNrwdSwitch_opMD(animal, category, varargin)
...
if p.Results.plotFlag
    ...
    errorbar((tMax*binSize/1000 + 20),glm_all.Coefficients.Estimate(end), abs(glm_all.Coefficients.Estimate(end) - CIbands(end,1)), abs(glm_all.Coefficients.Estimate(end) - CIbands(end,2)),'Color', [0.4 0.4 0.4],'linewidth',1)
