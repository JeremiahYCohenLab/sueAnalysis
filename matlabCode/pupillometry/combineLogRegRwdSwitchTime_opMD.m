function [glm_rwdLick, stayLickLat, switchLickLat, binSize, timeMax, combinedITIlicks] = combineLogRegRwdSwitchTime_opMD(animal, category, varargin)
...
%regression model
glm_all = fitglm([rwdMatx',preITIs'], eve, 'distribution','binomial','link','logit');
