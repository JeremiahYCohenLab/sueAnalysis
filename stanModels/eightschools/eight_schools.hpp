...
namespace eight_schools_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/zhixi/Documents/gitRepositories/sueAnalysis/stanModels/eight_schools.stan");
    reader.add_event(16, 14, "end", "C:/Users/zhixi/Documents/gitRepositories/sueAnalysis/stanModels/eight_schools.stan");
    return reader;
}

class eight_schools_model : public prob_grad {
private:
        int J;
        std::vector<double> y;
        std::vector<double> sigma;
public:
    eight_schools_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "eight_schools_model_namespace::eight_schools_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "eight_schools_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
